...
- `Home-Lab-Hardware-Inventory-final-2026-08-20.pdf` — physical systems, VM roles, authoritative addressing, deployment status, and memory plans.
- `Authoritative-VLAN-Designations-final-2026-08-20.txt` — authoritative VLAN IDs, hostnames, and IP assignments.
